 ...
 *   8. First action is always "TimeLimitedCache" and must be executed immediately, with a
 *      0-millisecond delay
 */
...
class TimeLimitedCache {
  ...
  set(key, value, duration) {
    ...
    this.cache[key].lifeTime = setTimeout(this.delete.bind(this), duration, key);
    return true;
  }
